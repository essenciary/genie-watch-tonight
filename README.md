...
Genie MVC web application showing how to build a user facing web page together with a REST API for querying a Netflix titles database.

---

> Discussion: a quick look at what we're building
>
> Discussion: a quick look at the data
...
> Discussion: the various types of Genie apps
>
> Discussion: why MVC
...
> Discussion: quick look at the folder structure
...
> Discussion: the role of initializers
>
> Discussion: Genie's support for environments and the config/env/ folder
...
> Discussion: what are database migrations
...
> Discussion: the migrations DSL
>
> Discussion: `SearchLight.Migrations` and running migrations
...
> Discussion: Genie's template files
>
> Use of partials
...
> Discussion: `linkto` inverse routing
...
> Discussion: the `find` method
>
> Discussion: the `@params` collection

Time to check our progress: <http://127.0.0.1:8000/movies>

## Building the REST API

> Discussion: how to build API URIs
...
> Discussion: installing and using plugins
